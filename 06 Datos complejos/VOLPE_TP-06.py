...
cosas_que_me_gustan = ["libros", "cerámica", "música", "rompecabezas", "chocolate"]
print(cosas_que_me_gustan[3])

cosas_que_me_gustan = ["pintar", "cerámica", "música", "rompecabezas", "chocolate"]
...
lista_vacia.append(input("Ingresa una palabra: "))
lista_vacia.append(input("Ingresa una palabra: "))
lista_vacia.append(input("Ingresa una palabra: "))
...
#1: Crea una lista con los valores: [8, 15, 3, 22, 7]
#2: Identifica el numer maximo de la lista (max(numeros)
#3: Elimina ese número máximo con remove numeros.remove(max(numeros)), en este caso sería el 22
#4: Imprime la lista que quedó [8, 15, 3, 7]     
